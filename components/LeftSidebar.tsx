...
const LeftSidebar = () => {
  ...
  return (
    <section className="left_sidebar h-full">
        <nav className="flex flex-col gap-6 h-[100vh]">
            <Link href="/">
            <Image src='/icons/logo.svg' alt='logo'
            width={23} height={27} />
            <h1 className="text-24 font-extrabold text-white max-lg:hidden">Podcast Player</h1>
            </Link>
